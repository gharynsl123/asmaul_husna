import 'package:asmaul_husna/view/text_style.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      child: ListView.builder(
        itemCount: arabItem.length,
        itemBuilder: (BuildContext context, int index) {
//          buat nama istilah dari nama string di atas yang kayak itu tuh title itu istilah nya si arabitem
//        nah disini kasih aja istilahnya
          final title = arabItem[index].toString();
          final sub = artiItem[index].toString();
//         masuk ke bagian kotak list item jadi ini buat edit edit
//          atau kasih warna kotaknya lengkungan nya jaraknya
          return Container(
//            jarak atara kotak dan pinggiran hp
            padding: EdgeInsets.all(10.0),
            child: GestureDetector(
              child: Stack(
                children: <Widget>[
                  Container(
//                    ini untuk ngepasin kotaknya sama pinggiran hp
                    width: MediaQuery
                        .of(context)
                        .size
                        .width - 000,
//                    jarak antara tulisan sama pojok kotak
                    padding: const EdgeInsets.all (10),
//                    ini ambil istilah dari yang antum buat tadi
